...
from .views import homepage_view, fiction_page_view, fiction_create_view, fiction_edit_view, fiction_delete_view
...
urlpatterns = [
    ...
    path("<int:fiction_id>/del/", fiction_delete_view.delete_fiction, name="fiction_del"),
