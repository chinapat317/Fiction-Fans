...
urlpatterns = [
    ...
    path("fiction/<int:fiction_id>/", fiction_view.fiction_view, name="fiction_view"),
    path("fiction/<int:fiction_id>/<int:chapter_id>", fiction_view.chapter_view, name="chapter_view"),
]
