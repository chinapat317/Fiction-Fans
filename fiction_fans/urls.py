...
from .views import homepage_view, fiction_view, fiction_create_view, fiction_edit_view


app_name = "fiction_fans"
urlpatterns = [
    path("", homepage_view.HomePage.as_view(), name="homepage"),
    path("<int:fiction_id>/", fiction_view.fiction_view, name="fiction_view"),
    ...
    path("<int:fiction_pk>/<int:chapter_pk>/", fiction_view.ChapterView.as_view(), name="chapter_view"),
